...
Помимо ответов на вопросы в реальном времени, система может генерировать автоматический ежедневный дайджест по заранее заданным вопросам.

Вместо ручных запросов можно заранее подготовить список тем:

- последние новости по XRP  
- что происходит с Bitcoin сегодня  
- ключевые макро-тренды недели  

Вопросы хранятся в отдельной Google Таблице.
